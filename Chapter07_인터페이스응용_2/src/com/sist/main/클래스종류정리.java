 ...
 *               ㅣ자바포함 JSP 포함            ㅣJquery,NodeJS,VueJS
 * => 상속
 *       ---- 기존의 클래스의 기능을 받아서 재사용
 *       ---- 추상클래스 : extends => 단일 상속
 *       ---- 인터페이스 : implements => 다중 상속
 *                                                      --------- 윈도우
 *       ---- MVC구조 만드는 경우 => 인터페이스 =< 어노테이션
...
public class 클래스종류정리 {
	public static void main(String[] args) {
		...
		{
			System.out.println("obj는 string?");
		}
