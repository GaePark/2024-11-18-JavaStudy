 ...
 *            *** 초기화시에는 주로 생성자를 이용한다
 *                                          -----
 *                                          인스턴스 변수 , static변수를 사용할 수 있다.
 *            *** static 변수에 대한 초기화는 static블럭을 이용 
 *                  => 초기화 블럭
 *         ----------------
 *         메소드 : 기능 설계
 *                    --------- 설정된 변수를 어떻게 사용
 ...
 *                 ----- (new 대체) 객체 생성 방법이 있따 => 리플렉션 (클래스명만 있으면 처리가 가능)
 *                                                                           --------
 *                                                                           스프링 => 스프링 가능자
 *                                                                           
 *              
 *           설계 (class작성) ===> 메모리 저장 ==> 활용 ==> 메모리 회수
 *               class ClassName => new 생성자()   ===          null => System.
 *               {                                                   .메소드() 
 *                  변수 / 메소드 / 생성자                      .변수명
 *               }
 *               *** 변수만 가지고 있는 경우
