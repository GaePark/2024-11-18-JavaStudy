 ...
 *     2) static 메소드, static변수sms this를 사용할 수 없다.
 *     3) static 블록은 static 변수만 초기화가 가능
 *     4) 인스턴스 메소드에서는 인스턴스변수, static을 사용할 수 있따
 *     5) 초기화 => 생성자를 이용하는 이유
 *                         -----this, 인스턴스 , static
 ...
 *                       생성자 , 메소드
 * ----------------------------------------------------------------------------
 * private          멤버변수 , 생성자         자신의 클래스 내부          클래스 외부에서 사용이 불가능
 *                        메소드
 * ----------------------------------------------------------------------------
 * => 크기
 ...
 *   
 *   클래스 : public / default => public : 모든 클래스 사용 가능
 *                                           -------
...
class Member
{
	private String id; // Member클래스 안에서만 빨산색
	protected String pwd;// 같은 폴더 노란색
	int age;// 같은 폴더 파란색
	public String name; // 모든 클래스 초록색
}
