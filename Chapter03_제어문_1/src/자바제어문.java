 ...
 *           	조건이 false일떄 처리
 *           }
 *     = 다중 조건문 : 메뉴처리, 키보드처리, 별점처리
 *       *** 여러개의 조건문을 사용하지만 한개의 조건만 수행한다.
 *       형식)
 *              if(조건문)
 *              {
 *              	조건 true 일떄 수행 ==> 종료
...
// 다중 조건문 예제
// => 사용자로부터 정수 2개 연산자 (+,-,*,/)
//                                -- 중첩 조건문 => 나누기 값이 0이 아니게 확인
// 프로그램은 비정상 종료가 없는 프로그램, 사전에 오류를 방지
// 웹 => 비정상 종료를 방지 => 에러가 발생 => 건너뛴다(다음 문장으로 넘어감)
// => 8장 예외처리
...
public class 자바제어문 {
	...
	public static void main(String[] args) {
		...
		// 자바에서 클래스를 저장할때 => 반드시 new를 동적 메모리 할당(저장)해야함
