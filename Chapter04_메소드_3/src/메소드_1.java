 ...
 *   데이터 저장
 *       = 변수 : 한개의 데이터 저장
 *       = 배열 : 여러개의 데이터 저장 => 인덱스 : 고정적 / 같은 데이터형만
 ...
 * 형식)
 		...
 		--------------------------------------------
 						...
 						ㅣ => 오라클 연결시에 insert/update/delete
 		--------------------------------------------
 						X						X
 		...
 		----------
 		 ...
 		 데이터형 변수 = 메소드(전송하는 값)
 		              ㅣ      ㅣ
 		              --------
		=> 왼쪽에 있는 데이터형이 더 크거나 같아야함 => 권장(같은 데이터형)
		=> 통계 / 회계
...
public class 메소드_1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("1번문장");
		display();
		System.out.println("2번문장");
		display();
		System.out.println("3번문장");
		display();
