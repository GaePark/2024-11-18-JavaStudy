 ...
 *         		=> 반드시 클래스명과 동일 
 *         		Scabber scan = new Scanner(System.in)
 *                                            -------------
 *                                            생성자는 반드시 호출시에 new
 *                                            new => 클래스의 메모리 크기 확인
 *                                                         => 메모리 배정
 ...
 *         게시판 , 관리페이지 ...
 *         
 * 9) 예외처리 : 사전에 에러 방지 , 비정상 종료 방지하고 정상 상태 유지
 * 		= 예외복구 try~catch
 * 		= 예외회피 throws Exception => 
 * 		=
 *     반드시 예외처리 해야되는 클래스 / 생략이 가능
 *     ------------------------------
 *         ㅣ컴파일시에 확인                 ㅣ실행시에 확인
 *         ㅣCheckException                사용자 에러 
